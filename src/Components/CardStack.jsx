...
function CardStack() {
  ...
  return (
    <>
      ...
      <p className='mx-5 md:mx-44'>Celebrate this diwali with short and fresh quotes from <span className='font-bold'>"Happy Diwali SMS"</span> team and also you can share this page with all your whatsApp contacts, Facebook page Groups and twitter handle.</p>
