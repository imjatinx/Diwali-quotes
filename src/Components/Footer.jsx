...
function Footer() {
  return (
    <footer className="footer footer-center pb-20 p-10 bg-primary text-primary-content">
      <div>
        ...
        <p className="font-bold">
          Quote Community Project by Nitaj Tales <br />Providing Best Quotes/Shayari Ever.
        </p>
        <p>Copyright © 2022-23 - All right reserved</p>
      </div>
    </footer>
  )
}
